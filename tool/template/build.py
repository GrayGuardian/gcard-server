...
luaRoot = "../../../gcard-client/Assets/Resources/AssetBundles/lua/template/"
xlsfile = os.getcwd()+"\\template.xlsx" # 打开指定路径中的xls文件
book = xlrd.open_workbook(xlsfile)#得到Excel文件的book对象，实例化对象

config = [
	{"name":"error_code","sheet":"错误代码表"}
];
...
def writeToFile( name,sheet ):
	...
	print "Js PB === Name:"+name+" File:"+filePath

	filePath = luaRoot+"template_"+name+".lua.txt"
	fnew = open(filePath, "w")
	fnew.write(luaContent);
	print "Lua PB === Name:"+name+" File:"+filePath
